/*
 * nRF24L01 LIBRARY FOR SPARK CORE
 * =======================================================
 ...
 *    Date: Feb 19th 2014
 * =======================================================
 * https://github.com/technobly/SparkCore-nRF24L01
 */
...
void nRF24L01::print_status(uint8_t status)
{
...
void nRF24L01::printDetails(void)
{
...
void nRF24L01::startWrite( const void* buf, uint8_t len )
{
...
void nRF24L01::setPALevel(rf24_pa_dbm_e level)
{
...
rf24_pa_dbm_e nRF24L01::getPALevel(void)
{
...
bool nRF24L01::setDataRate(rf24_datarate_e speed)
{
    bool result = false;
    uint8_t setup = read_register(RF_SETUP) ;
...
void nRF24L01::setCRCLength(rf24_crclength_e length)
{
